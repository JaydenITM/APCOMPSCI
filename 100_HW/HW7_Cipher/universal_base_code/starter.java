...
class starter {
    public static void main(String args[]) {
        ...
        int starter = 0;
         while(starter<37)
        {
            System.out.println(Cipher.keyedEncode("u4y i1e i5 i6ita5c 314c1i66e1 i5f by6i5 hea5c zbi58 u4y",starter));
            System.out.println(Cipher.keyedEncode("amlb mfhp7fcj jlgq fo tap s9a bjlslql aflipa lb hlg9b 210z t9ct",starter));
            starter++;
        }
        System.out.println(Cipher.encode("v2q9w1 1r q25 85rq uy9l5s 5o5s"));
        System.out.println("---------------------------------------------------------");
        System.out.println("Write a code to then be encoded");
        Scanner sc = new Scanner(System.in);
        String c = sc.nextLine();
        System.out.println(Cipher.encode(c));
